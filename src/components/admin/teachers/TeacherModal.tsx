...
import { createTeacher, updateTeacher, type TeacherInput } from "@/app/admin/teachers/actions"
...
export function TeacherModal({
  ...
  const [formData, setFormData] = useState<TeacherInput>({
    ...
    telegram: teacherToEdit?.telegram || "",
    instagram: teacherToEdit?.instagram || "",
    sortOrder: teacherToEdit?.sortOrder ?? 0,
      ...
      <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 z-10 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800 shrink-0">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">
            {teacherToEdit ? "O'qituvchini tahrirlash" : "Yangi o'qituvchi qo'shish"}
          </h2>
          <button
            onClick={onClose}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="Masalan: Frontend (React/Next.js)"
                />
                {fieldErrors.specialization && (
                  <p className="text-xs text-red-500">{fieldErrors.specialization}</p>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="Masalan: 5+ yil tajriba"
                />
                {fieldErrors.experience && (
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-100 dark:border-slate-800 shrink-0 bg-slate-50/50 dark:bg-slate-900/50 rounded-b-2xl">
          ...
          >
            {isPending ? (
              ...
              <span>{teacherToEdit ? "Saqlash" : "Qo'shish"}</span>
            )}
          </button>
        </div>
      </div>
