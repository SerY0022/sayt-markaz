...
import { deleteStatistic } from "@/app/admin/statistics/actions"
import type { StatisticRecord } from "./StatisticsModal"
...
export function DeleteConfirmModal({
  ...
  const handleDelete = async () => {
    ...
    const result = await deleteStatistic(statistic.id)
    setLoading(false)
        ...
        <div className="p-6 text-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">
              Statistikani o'chirishni tasdiqlaysizmi?
            </h3>
